...
const namesArr = ["Шарипов Джумар", "Болотова Мээрим", "Эржан", "Ибраимов Айдарбек", "Жайлообеков Нурбол", "Абдылдаев Айдар", "Курбанкулов Ислам", "Курманалиев Нурбек", "Карасартов Азамат", "Кадыров Мирбек", "Аскарбекова Магира", "Абакиров Баястан", "Жылдызбек у. Актилек", "Асанов Акжол"];
